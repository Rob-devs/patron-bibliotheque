...
public class ControllerUsager {
    ...
    public void openPopupAddUsager() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ihm/backoffice/AjouterUsager.fxml"));
    ...
    public void openPopupUpdateUsager() {
        try {
            // Charger le fichier FXML de la fenêtre pop-up
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ihm/backoffice/UpdateUsager.fxml"));
            Parent root = loader.load();
