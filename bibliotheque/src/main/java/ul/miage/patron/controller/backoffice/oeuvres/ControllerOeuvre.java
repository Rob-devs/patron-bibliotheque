...
import ul.miage.patron.controller.backoffice.exemplaires.ControllerAddExemplaire;
...
public class ControllerOeuvre {
    ...
    public void openPopupAddOeuvre() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ihm/backoffice/AjouterOeuvre.fxml"));
    ...
    public void openPopupaddExemplaire() {
        try {
            // Charger le fichier FXML de la fenêtre pop-up
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ihm/backoffice/AjouterExemplaire.fxml"));
            Parent root = loader.load();
    ...
    public void openMenuEmprunt() {
        try {
            App.switchScene("frontoffice/MenuEmprunt");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
