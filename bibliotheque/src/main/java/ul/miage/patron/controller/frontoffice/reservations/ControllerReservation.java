package ul.miage.patron.controller.frontoffice.reservations;
...
public class ControllerReservation {
    ...
    public void openPopupAddReservation() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ihm/frontoffice/AjouterReservation.fxml"));
